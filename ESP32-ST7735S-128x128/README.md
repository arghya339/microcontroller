...
```ino
/*********************************************************
Copyright (C) 2026, Mukuldeep Maiti <github.com/mukuldeep>
Modified by Arghyadeep Mondal <github.com/arghya339>
*********************************************************/
...
const char* ssid       = "Arghya-erAndroid";  // YOUR_WIFI_SSID
const char* password   = "0123456789";  // YOUR_WIFI_PASSWORD
...
void setup(void) {
  tft.init();
  tft.setRotation(0);  // 0–3; try different values if display is upside down
...
void printLocalTime()
{
  ...
  tft.setCursor(3, 15, 2);
  //tft.setTextColor(TFT_WHITE,TFT_BLACK);
  tft.setTextColor(TFT_CYAN, TFT_BLACK);  
  tft.setTextSize(1);
  tft.println(&timeinfo, "%h %d %Y");

  tft.setCursor(1, 30, 4);
  //tft.setTextColor(TFT_WHITE,TFT_BLACK); 
  tft.setTextColor(TFT_CYAN, TFT_BLACK); 
  tft.setTextSize(2);
  tft.println(&timeinfo, "%I:%M");

  tft.setCursor(8, 70, 2);
  tft.fillRect(8, 70, 115, 45, TFT_PINK);

  tft.setCursor(14, 80, 2);
  //tft.setTextColor(TFT_WHITE,TFT_BLACK); 
  ...
  int barWidth = (currentSeconds * TFT_WIDTH) / 60; 
  if(currentSeconds == 0){
    tft.fillRect(3, 117, 120, 10, TFT_BLACK);  // clear previous progress-bar
  }

  tft.fillRect(3, 117, barWidth-5, 10, TFT_GREEN);  // progress-bar outer frame
  tft.fillRect(5, 119, barWidth-9, 6, TFT_BLACK);  // progress-bar inner frame
  ...
  tft.fillRect(6, 120, barWidth-11, 4, barColor);  // main progress-bar

  tft.fillRect(barWidth-2, 117, 2, 10, TFT_CYAN);  // progress-bar end pointer
  //tft.fillRect(3+barWidth-1, 118, 6, 3, barColor);  // small colored rect at top of the pointer
  //tft.fillRect(3+barWidth-1, 123, 6, 3, barColor);  // small colored rect at bottom of the pointer
